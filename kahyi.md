...
- [2판: 2016. 1. 29. (무효)](https://github.com/kahyi/kahyi.github.io/blob/8e556c41de57e2e658e2316fb66b4c848022ec4e/kahyi.md)
  - **1개: 2016. 1. 30. (최신)**
...
끝소리 있는 **ㅇ** 명령과 끝소리 있는 **ㅎ** 명령을 사용해서 파일을 열고 닫을 수 있습니다.
아희와는 달리, 스트림에 대한 **ㅍ** 명령은 끝소리 없는 **ㅇ** 명령처럼 동작합니다.

- **ㅇ** + *끝소리*: (나중 이동) 값을 모두 뽑아 만든 문자열이 가리키는 파일을 끝소리 공간에 읽고 쓰기 상태로 열기. (새롬) [^1] [^2]
- **ㅃ** + *끝소리 없음*: (나중 이동) 마지막으로 보낸 값을 넣기.
- **ㅃ** + *__ㅇ__ 또는 __ㅎ__을 제외한 끝소리*: (나중 이동) 마지막으로 보낸 값을 넣기. (새롬) [^1]
- **ㅎ** + *끝소리*: (나중 이동) 끝소리 공간을 닫기. (새롬) [^1] [^2]
